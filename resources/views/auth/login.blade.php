    ...
    <div>
        <section class="relative pt-52 xs:pt-40 pb-16 md:pb-24 lg:pb-52 bg-orange-50 overflow-hidden">
            ...
            <p class="absolute top-0 right-0 mt-32 xs:mt-12 mr-5">
                ...
                <a class="inline-block font-medium underline hover:text-lime-600" href="{{ route('register') }}">Create an account</a>
            </p>
                ...
                <div class="max-w-sm mx-auto">
                    <form action="{{ route('login.post') }}" method="POST">
                        ...
                        <div class="text-right mb-10">
                            <a href="#!" class="inline-block text-sm underline font-medium">Forgot password?</a>
                        </div>
