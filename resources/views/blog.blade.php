      ...
      <div class="container mx-auto px-4">
        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full lg:w-1/2 xl:w-7/12 px-4 mb-8 lg:mb-0">
            <div><img class="block w-full mb-8" src="fauna-assets/blog/image-lg-post.png" alt="" />
              <div class="mb-6"><a class="inline-block mr-2 px-2 text-sm font-medium hover:bg-gray-50 border rounded-full" href="#!">Solar Power</a> <a class="inline-block px-2 text-sm font-medium hover:bg-gray-50 border rounded-full" href="#!">Solutions</a></div><a class="block group max-w-2xl" href="#!">
                ...
                <div class="flex items-center"><img class="w-10 h-10 rounded-full" src="fauna-assets/blog/avatar-1.png" alt="" />
          ...
          <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
            <div class="max-w-lg"><a class="flex flex-wrap sm:flex-nowrap group mb-8 items-center" href="#!"><img class="block" src="fauna-assets/blog/image-sm-1.png" alt="" />
                <div class="mt-6 sm:mt-0 sm:ml-8">
                  ...
                  <div class="flex items-center"><img class="w-8 h-8 rounded-full" src="fauna-assets/blog/circle-avatar-1.png" alt="" />
              ...
              </a> <a class="flex flex-wrap sm:flex-nowrap group mb-8 items-center" href="#!"><img class="block" src="fauna-assets/blog/image-sm-2.png" alt="" />
                <div class="mt-6 sm:mt-0 sm:ml-8">
                  ...
                  <div class="flex items-center"><img class="w-8 h-8 rounded-full" src="fauna-assets/blog/circle-avatar-2.png" alt="" />
              ...
              </a> <a class="flex flex-wrap sm:flex-nowrap group items-center" href="#!"><img class="block" src="fauna-assets/blog/image-sm-3.png" alt="" />
                <div class="mt-6 sm:mt-0 sm:ml-8">
                  ...
                  <div class="flex items-center"><img class="w-8 h-8 rounded-full" src="fauna-assets/blog/circle-avatar-3.png" alt="" />
                    <div class="flex items-center ml-4"><span class="text-sm font-medium">Leslie Alexander</span> <span class="mx-2 sm:mx-4">
                        <svg width="4" height="4" viewbox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <circle cx="2" cy="2" r="2" fill="#929C9A"></circle>
        ...
        <div class="hidden flex flex-wrap mt-16 -mx-4" :class="{'hidden': !showContent}">
          <div class="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
            <div class="max-w-lg"><a class="flex flex-wrap sm:flex-nowrap group mb-8 items-center" href="#!"><img class="block" src="fauna-assets/blog/image-sm-1.png" alt="" />
              ...
              </a> <a class="flex flex-wrap sm:flex-nowrap group items-center" href="#!"><img class="block" src="fauna-assets/blog/image-sm-2.png" alt="" />
                <div class="mt-6 sm:mt-0 sm:ml-8">
                  <h3 class="text-2xl font-medium group-hover:text-teal-600 transition duration-200 mb-6">From Trash to Treasure: The Promising World of Biomass Energy</h3>
                  <div class="flex items-center"><img class="w-8 h-8 rounded-full" src="fauna-assets/blog/circle-avatar-2.png" alt="" />
                    <div class="flex items-center ml-4"><span class="text-sm font-medium">Jenny Wilson</span> <span class="mx-2 sm:mx-4">
